...
def reference_context(prefetched, language="ko"):
    ...
    if language == "ko":
        rules = (
            ...
            "애널리스트 EPS의 GAAP/조정 기준이 원자료에 명시되지 않으면 기준 미확인으로 쓰세요. "
            "회사 가이던스와 기준이 같거나 다르다고 단정하지 마세요.\n"
        ...
        rules = (
            ...
            "If the source does not state whether analyst EPS is GAAP or adjusted, label its basis unverified. "
            "Do not assert that its basis matches or differs from company guidance.\n"
