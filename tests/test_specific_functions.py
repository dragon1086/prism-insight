...
# Manual smoke script, not an automated test: it needs real report files,
# a live LLM backend, and calls update_holdings() which mutates the DB.
# Run it directly with `python tests/test_specific_functions.py`.
